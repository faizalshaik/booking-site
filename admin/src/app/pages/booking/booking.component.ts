...
export class BookingComponent implements OnInit {
  ...
  public onClickSpot(modalContent, irow, spot) 
  {
    let svc = this;
    if(spot.state !=1 ) return;

    if(svc.selected_spot != null && spot == svc.selected_spot)
    {
      svc.selected_spot_row_index = -1;
      svc.selected_spot = null;    
    }
    else
    {
      ...
      svc.selected_spot_row_index = irow;  
    }
  }
